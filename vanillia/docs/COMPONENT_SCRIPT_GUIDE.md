...
현재 13개의 컴포넌트 스크립트가 이 가이드를 따라 구현되어 있습니다:
- Accordion, Checkbox Group, Chip, Dropdown
- File Card, File Upload, Input, LNB
- Modal, Popover, Slider, Tab, Tooltip

전체 구현 코드는 `components/scripts/` 폴더에서 확인할 수 있습니다.
