 ...
 */
function getEnabledComponents(framework = "vanilla") {
 ...
 */
function getComponentsByCategory(framework = "vanilla") {
  const grouped = {};
 ...
 */
function getComponentsInCategory(category, framework = "vanilla") {
 ...
 */
function isComponentEnabled(comp, framework = "vanilla") {
  const enabled = normalizeEnabled(comp.enabled);
  return enabled[framework] === true;
}

// 전역 노출 (Vanilla 호환성 유지)
...
// ES Module export (React/MUI에서 사용)
